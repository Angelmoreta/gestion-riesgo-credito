"""
Django settings for gestion_riesgo project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-u$kk!g7g-c388yu%=)dh*#i%+bfx!$^ivw5^yv^9%a4g))f7r&')
...
ROOT_URLCONF = 'gestion_riesgo.urls'
...
WSGI_APPLICATION = 'gestion_riesgo.wsgi.application'
